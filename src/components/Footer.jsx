      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold mb-4">Godrej Properties</h3>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-6">
              <a href="#" className="bg-gray-700 hover:bg-gray-600 rounded-full p-2">
          ...
          <div>
            ...
            <form className="space-y-3">
              <input 
                ...
                className="w-full px-4 py-2 border rounded text-gray-800 focus:outline-none focus:ring-2 focus:ring-green-500"
              />
              <button 
                type="submit" 
        ...
        <div className="border-t border-gray-700 mt-10 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0 text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} Saahas InfraBuild. All rights reserved.
            </div>
